...
docker exec $CONTAINER_ID zap-cli  -v -p 2375 spider $TARGET_URL

docker exec $CONTAINER_ID zap-cli -v -p 2375 active-scan $TARGET_URL

docker exec $CONTAINER_ID zap-cli -v -p 2375 alerts
